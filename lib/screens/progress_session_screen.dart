...
class ProgressSessionScreen extends StatefulWidget {
  SessionModel session;
  final int replacementid;
  final String appbartext;
  final int currentindex;

  ProgressSessionScreen({
    super.key, 
  ...
  @override
  State<ProgressSessionScreen> createState() => _ProgressSessionScreenState();
}

class _ProgressSessionScreenState extends State<ProgressSessionScreen> {
